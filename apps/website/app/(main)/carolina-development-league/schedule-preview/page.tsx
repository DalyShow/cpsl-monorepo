...
import { getCdlClubs, CDL_MATCHES, CDL_AGE_GROUPS } from "@/lib/cdlSchedule";
import { ScheduleExplorer } from "../schedule/ScheduleExplorer";

/** Revalidate hourly, same as the live schedule page. */
export const revalidate = 3600;

/**
 * REVIEW PAGE for the schedule v2 experience (season view + add to
 * calendar). Unlinked + noindex. Promotion = the live schedule page
 * swaps CalendarBody → ScheduleExplorer, then this folder is deleted.
 */
export const metadata: Metadata = {
  title: "Match Calendar (Preview) — Carolina Development League",
